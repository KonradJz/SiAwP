ALTER TABLE LOCATIONS DROP CONSTRAINT SYS_C00128346;
ALTER TABLE LOCATIONS DROP CONSTRAINT SYS_C00128347;
DROP TABLE COUNTRIES;
ALTER TABLE DEPARTMENTS DROP CONSTRAINT SYS_C00128348;
ALTER TABLE DEPARTMENTS DROP CONSTRAINT SYS_C00128358;
ALTER TABLE DEPARTMENTS DROP CONSTRAINT SYS_C00128359;
ALTER TABLE JOB_HISTORY DROP CONSTRAINT SYS_C00128355;
ALTER TABLE JOB_HISTORY DROP CONSTRAINT SYS_C00128356;
ALTER TABLE JOB_HISTORY DROP CONSTRAINT SYS_C00128357;
ALTER TABLE EMPLOYEES DROP CONSTRAINT SYS_C00128351;
ALTER TABLE EMPLOYEES DROP CONSTRAINT SYS_C00128352;
ALTER TABLE EMPLOYEES DROP CONSTRAINT SYS_C00128351;
...
SELECT d.department_name, SUM(e.salary) AS Suma_Zarobków, ROUND(AVG(e.salary)) AS ?rednia_Zarobków
FROM DEPARTMENTS d
...
SELECT DISTINCT e1.first_name, e1.last_name, e2.first_name AS wspó?pracownik_imi?, e2.last_name AS wspó?pracownik_nazwisko
FROM EMPLOYEES e1
